...
src_url=http://mirror.wizmacau.com/apache/tomcat/v$tomcat_8_version/apache-tomcat-$tomcat_8_version.tar.gz && Download_src
src_url=http://mirror.wizmacau.com/apache/tomcat/v$tomcat_8_version/catalina-jmx-remote.jar && Download_src
